...
const NAVIGATION_TAB_ITEMS = [
	{ label: "Dashboard", href: PAGE_ROUTE.DASHBOARD, icon: DashboardIcon },
	{ label: "Milestones", href: PAGE_ROUTE.MILESTONES, icon: MilestonesIcon },
	{
		label: "Progress Reports",
		href: PAGE_ROUTE.PROGRESS_REPORTS,
		icon: ProgressReports,
	},
	{ label: "Defects", href: PAGE_ROUTE.DEFECTS, icon: Quotes },
	{ label: "Project Images", href: PAGE_ROUTE.PROJECT_IMAGES, icon: ViewLogs },
];
